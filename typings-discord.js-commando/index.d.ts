declare module 'discord.js-commando' {
    ...
    export class ArgumentType {
        ...
        public validate(value: string, msg: CommandMessage, arg: Argument): boolean | string | Promise<boolean
            | string>;
    }
    ...
    export class Command {
        ...
        public run(message: CommandMessage, args: {} | string | string[], fromPattern: boolean): Promise<Message
            | Message[]>
    ...
    export class CommandDispatcher {
        ...
        private cacheCommandMessage(message: Message, oldMessage: Message, cmdMsg: CommandMessage, responses: Message
                                        | Message[]): void;
    ...
    export class CommandMessage {
        ...
        public embed(embed: RichEmbed | {}, content?: StringResolvable, options?: MessageOptions): Promise<Message
            | Message[]>;
        ...
        public replyEmbed(embed: RichEmbed | {}, content?: StringResolvable, options?: MessageOptions): Promise<Message
            | Message[]>;
    ...
    export class CommandoClient extends Client {
        ...
        public on(event: 'commandError', listener: (command: Command, err: Error, message: CommandMessage, args: {}
                                                        | string
                                                        | string[], fromPattern: boolean) => void): this;
        ...
        public on(event: 'commandRun', listener: (command: Command, promise: Promise<any>, message: CommandMessage, args:
                                                      {}
                                                      | string
                                                      | string[], fromPattern: boolean) => void): this;
